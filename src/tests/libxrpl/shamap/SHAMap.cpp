...
// A forged path of 65 hash-chained inner nodes reaches depth kLeafDepth, where selectBranch would
// index byte 32 of a 32-byte key. Such a path must be rejected rather than read out of bounds.
